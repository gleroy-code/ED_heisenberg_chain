...
def ham_chain_in_alpha(alpha):
    ...
    poi=[[truncate(i-C,3),d_alpha] for i in s]
...
for i in dec_aslistoflists:
    ...
    #print("For the irrep alpha =")
    #print(i)
    #print("The eingenvalue are = ")
    #print(ham_chain_in_alpha(i))
    spectrum_mult_chain.append(ham_chain_in_alpha(i))
    #print(" ")

poi=[item for sublist in spectrum_mult_chain for item in sublist]
...
for i in poi:
    ...
    if i[0] not in mom1:
        ...
        for j in range(poi.index(i)+1,len(poi)):
            if poi[j][0]==i[0]:
                mom2[len(mom2)-1]+=poi[j][1]    
    
print("Voici donc le spectre de l'hamiltonien pour la chaine de SU(3) :")   
print(mom1)
print("et les degenerescence correspondantes")
print(mom2) 
